...
from mp1.common.pytorch_util import dict_apply, optimizer_to
from mp1.model.mean.ema_model import EMAModel
from mp1.model.common.lr_scheduler import get_scheduler
import warnings
warnings.filterwarnings("ignore")

OmegaConf.register_new_resolver("eval", eval, replace=True)

class TrainMP1Workspace:
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: MP1 = hydra.utils.instantiate(cfg.policy)

        self.ema_model: MP1 = None
    ...
    def run(self):
        ...
        for local_epoch_idx in range(cfg.training.num_epochs):
            ...
            if (self.epoch % cfg.training.rollout_every) == 0 and RUN_ROLLOUT and env_runner is not None:
                ...
                test_scores.append(runner_log['test_mean_score'])
...
def main(cfg):
    workspace = TrainMP1Workspace(cfg)
    workspace.run()
