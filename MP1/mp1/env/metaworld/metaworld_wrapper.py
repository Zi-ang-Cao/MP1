...
from mp1.gym_util.mujoco_point_cloud import PointCloudGenerator
from mp1.gym_util.mjpc_wrapper import point_cloud_sampling
...
class MetaWorldEnv(gym.Env):
    ...
    def get_rgb(self):
        ...
        img = self.env.sim.render(width=512, height=512, camera_name="corner2", device_id=self.device_id)
        return img
