...
from mp1.model.mean.conv1d_components import (
    Downsample1d, Upsample1d, Conv1dBlock)
from mp1.model.mean.positional_embedding import SinusoidalPosEmb
...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, 
            ...
            local_cond=None, global_cond=None, r=None, training=True, **kwargs):
        """
        x: (B,T,input_dim)
        ...
        if training:           
            up_features_tensor = torch.stack([f.flatten(1) for f in down_latents[:-1]], dim=0)
            # return velocity_pred, features_for_regularization.flatten(1)
