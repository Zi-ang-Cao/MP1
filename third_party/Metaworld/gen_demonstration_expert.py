...
import zarr
import numpy as np
from mp1.env import MetaWorldEnv # type: ignore
...
def main(args):
	...
	e = MetaWorldEnv(env_name, device="cuda:0,1", use_point_crop=True)
...
if __name__ == "__main__":
	...
	parser.add_argument('--root_dir', type=str, default="/data/code/FlowPolicy/data/" )
